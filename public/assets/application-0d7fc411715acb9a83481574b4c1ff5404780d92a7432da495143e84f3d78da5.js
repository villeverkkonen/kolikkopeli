...
// 	update_money_balance(bet, "minus");
// }
...
// 	update_money_balance(amount, "plus");
// 	$("#game_money_amount").text(game_money_amount);
// }
...
// function money_balance(amount, direction) {
// 	$.ajax({
//       type  : 'POST',
//       data  : { "username"   : $("#current_player_username").text(),
//                 "amount"	 : amount
//               },
//       url   : "update_money_balance"
//   });
// }
;
(function() {
  $(function() {
    ...
    $(document).on('click', 'a[data-modal]', function() {
      ...
      $.get(location, function(data) {
        ...
        $(modal_holder_selector + ' #mainModalLabel').html(title);
      });
      return false;
    });
